...
class GameCheat_Lib(loader.Library):
  ...
  async def get_token(self, g):
    ...
    headers["Host"] = "api.gamee.com"
    headers["Connection"] = "keep-alive"
    headers["Content-Length"] = "224"
    headers["client-language"] = "en"
    headers["x-install-uuid"] = "436b1951-3fd0-42ac-887f-62dc5b328d41"
    headers["x-bot-header"] = "gamee"
  ...
  async def game_id(self, game_url):
    ...
    resp = requests.post('https://api.gamee.com/', headers=headers, data=data)
    result_data = resp.json()
